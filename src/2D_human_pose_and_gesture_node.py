...
from HumanPose2D.config import config as hp2d_cfg
...
class Human_Pose_2D_and_Gesture_predictor:
	def __init__(self, cfg):
		...
		# init models
		self.model_pose_2d = CNN_GAN_AS(hp2d_cfg.num_classes, is_training=False, norm_layer=torch.nn.BatchNorm2d)
